...
import { ReactComponent as ZapFullLogo } from "src/assets/zap-logo-full.svg";
  ...
  return (
    <div className={classes.login}>
      <div className={classes.contentWrapper}>
        <ZapFullLogo className={classes.logo} />
        ...
        <ConfirmationModal
          message={
            <Typography type="body1">
              DISCLAIMER: This version of the ZapChain will require frequent maintenance and
          ...
          title={`Welcome to the ZapChain ${deploymentName || ""}`}
        />
      )}
    </div>
  );
